...
public class TagResourceIntTest {
    ...
    public void initTest() {
        ...
        tag.setComment(DEFAULT_COMMENT);
    }
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getComment()).isEqualTo(DEFAULT_COMMENT);
    }
    ...
    public void updateTag() throws Exception {
        ...
        // Update the tag
        tag.setLabel(UPDATED_LABEL);
        tag.setComment(UPDATED_COMMENT);
        ...
        assertThat(testTag.getComment()).isEqualTo(UPDATED_COMMENT);
    }
